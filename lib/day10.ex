defmodule KnotHash do
  ...
  def build(list_length \\ 256), do: %KnotHash{ list: Enum.to_list(0..(list_length-1)), list_length: list_length }
...
defmodule Day10 do
  ...
  def part2(input) do
    padded_input = input <> @length_padding |> to_charlist

    KnotHash.build()
    |> KnotHash.hash(padded_input)
  end
end
